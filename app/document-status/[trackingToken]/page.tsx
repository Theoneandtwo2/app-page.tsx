...
const STATUS_LABELS: Record<string, { label: string; color: string }> = {
  ...
  missing_info: { label: "Missing Info Needed", color: "bg-orange-100 text-orange-800" },
};
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-start justify-center p-6">
      <div className="bg-white rounded-2xl shadow-md p-8 max-w-lg w-full">
        <h1 className="text-2xl font-bold text-gray-800 mb-1">Document Submission Status</h1>
        <p className="text-gray-500 text-sm mb-6">Gol Homes Subcontractor Portal</p>
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="font-medium text-gray-800">{doc.document_types}</span>
          </div>
          <div className="flex justify-between text-sm">
        ...
        <div className="border-t border-gray-100 pt-5 mb-5">
          <p className="text-sm font-semibold text-gray-600 mb-2">Review Status</p>
          <span
        ...
        {fileList.length > 0 && (
          <div className="border-t border-gray-100 pt-5">
            <p className="text-sm font-semibold text-gray-600 mb-2">Submitted Files</p>
            <ul className="space-y-1">
              {fileList.map((f, i) => (
                <li key={i} className="text-sm text-gray-700 flex items-center gap-2">
                  <span className="text-gray-400">•</span>
                  <span className="font-medium">{fieldLabels[f.field] ?? f.field}:</span>
